...
class NotesListViewController: UIViewController, UITableViewDataSource {
    ...
    func setupFetchedResultsController() {
        ...
        fetchedResultController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: dataController.viewContext, sectionNameKeyPath: nil, cacheName: "notes\(notebook.name!)")
        fetchedResultController.delegate = self
        
        do {
            try fetchedResultController.performFetch()
        } catch {
            fatalError("Error performing fetch: \(error.localizedDescription)")
        }
